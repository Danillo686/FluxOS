...
import { Owner } from "../type/Owner.js"
...
export const getIdOwner = async (
    req: Request<{id: string}, {}, Owner>,
    res: Response
):Promise<any> => {
...
export const putOwner = async (
    req: Request<{id: string}, {}, Owner>, // id para ser o parametro da URL e fazer o UPDATE
    res: Response
): Promise<any> => {
    const {id} = req.params
...
export const loginOwner = async (
    req: Request <{}, {}, {nome: string, cpf: string, email: string, senha: string, telefone: string}>, // --> Parametros para o login se feito corretamente
    res: Response
):Promise <any> => {
